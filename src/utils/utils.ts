...
/**
 * Converts the color string format "rgb(226, 226, 226)" into the color string format "#E2E2E2"
 * 
 */
export function rgbToHex(rgb: string): string {
    ...
    const rgbAry = rgb.substr(4).split(")")[0].split(sep);
  
    var r = (+rgbAry[0]).toString(16),
        g = (+rgbAry[1]).toString(16),
        b = (+rgbAry[2]).toString(16);
